<template>
    <div class="w-[27rem] lg:w-[25rem] 2xl:w-478.63 h-[calc(100vh-80px)] z-100 flex-col gap-2 xl:flex right-side-bar ">
        ...
        <div class="bg-dapp-black-2 p-3 xl:p-4 rounded-lg no-selection">
            ...
            <div v-if="activeTab === 'card'" class="flex mt-3 2xl:mt-4 justify-between gap-2 xl:gap-3">
                ...
                <button @click="handleCardModalOpen('card')"
            ...
            <div v-else class="flex mt-3 2xl:mt-4 justify-between gap-2 xl:gap-3">
                ...
                <button @click="handleCardModalOpen('watchlist')"
                    class="bg-dapp-white-10 h-8 w-8 lg:w-10 lg:h-10 rounded-lg text-white hover:bg-dapp-blue flex justify-center items-center gap-2">
...
export default {
    name: "RightSidebar",
    components: {
        SvgIcon, TabButton, SignalCardList, ActionTable, Icon, Checkbox, CardMarketplaceModal
    },
    data() {
        return {
            activeTab: 'card',
